...
## Project Overview
This project implements a lightweight, real-time credit risk pipeline. CSV data is converted into synthetic events, pushed through an in-memory queue, processed into a DataFrame, scored with a logistic regression model, and converted into actionable business recommendations. The workflow simulates real-time data ingestion, incremental ML scoring, and feature engineering in a modular, production-style architecture.
...
- Repository: [GitHub](https://github.com/PESIII23/real-time-credit-risk-simulation/tree/main)
